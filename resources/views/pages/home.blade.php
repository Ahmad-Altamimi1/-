    ...
    @section('content')
      ...
      **************************/
                        ...
                        @foreach ($recentposts as $recentpost)
                            <div class="blog-slider__item swiper-slide">
                                ...
                                <div class="blog-slider__content">
                                    ...
                                    <div class="blog-slider__text" dir="rtl">
                                        {{ \Illuminate\Support\Str::limit($recentpost->DESCRIPTION, 200) }}
                                    </div>
                                    <a href="{{ route('ShoWarticle', ['id' => $recentpost->id]) }}"
                                        class="blog-slider__button">أكملي المقال </a>
                                </div>
                            </div>
                        @endforeach
                        ...
                        <div class="lx-container-80">
                            <div class="lx-row">
                                <div class="lx-card carousel-container">
                                    ...
                                    <a class="prev has-dflex-center"><i class="fas fa-angle-left"></i></a><a
                                        class="next has-dflex-center"><i class="fas fa-angle-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </section>
        ...
        <div class="center_content container pt-60" dir="rtl">
            <div class="center_content_Right">
                ...
                <div class="hearts-wrapper">
                    <a class="trimester-one" style=""
                        href="{{ route('showtag', ['tag' => poststags::where('TITLE', '=', 'الثلث الأول')->first()->id]) }}"><img
                            src="{{ asset('pages/img/months/اول 1.webp') }}" alt="">
                        <div class="heart green">♥</div>
                    </a>
                    <a class="trimester-tow"
                        href="{{ route('showtag', ['tag' => poststags::where('TITLE', '=', 'الثلث الثاني')->first()->id]) }}"><img
                            src="{{ asset('pages/img/months/ثاني 2.webp') }}" alt="">
                        <div class="heart pink">♥</div>
                    </a>
                    <a class="trimester-three"
                        href="{{ route('showtag', ['tag' => poststags::where('TITLE', '=', 'الثلث الثالث')->first()->id]) }}"><img
                            src="{{ asset('pages/img/months/ثالث 3.webp') }}" alt="">
                                    ...
                                    <div class="post-tabs rounded bordered" dir="ltr">
                                        ...
                                        <ul class="nav nav-tabs nav-pills nav-fill" id="postsTab" role="tablist"
                                            ...
                                            <div class="multiple-items">
                                                ...
                                                <li class="nav-item" role="presentation"><button aria-selected="true"
                                                        class="nav-link" data-tag-title="الشهر الثاني" id="tag2"
                                                        type="button"> الشهر الثاني</button>
                                                </li>
                                                <li class="nav-item" role="presentation"><button aria-selected="true"
                                                        class="nav-link" data-tag-title="الشهر الثالث" id="tag3"
                                                        type="button">الشهر الثالث</button>
                                                </li>
                                                <li class="nav-item" role="presentation"><button aria-selected="true"
                                                        class="nav-link" data-tag-title="الشهر الرابع" id="tag4"
                                                        type="button"> الشهر الرابع</button>
                                                </li>
                                                <li class="nav-item" role="presentation"><button aria-selected="true"
                                                        class="nav-link" data-tag-title="الشهر الخامس" id="tag4"
                                                        type="button">الشهر الخامس </button>
                                                </li>
                                                <li class="nav-item" role="presentation"><button aria-selected="true"
                                                        class="nav-link" data-tag-title="الشهر السادس" id="tag5"
                                                        type="button"> الشهر السادس</button>
                                                </li>
                                                <li class="nav-item" role="presentation"><button aria-selected="true"
                                                        class="nav-link" data-tag-title="الشهر السابع" id="tag6"
                                                        type="button">الشهر السابع</button>
                                                </li>
                                                <li class="nav-item" role="presentation"><button aria-selected="true"
                                                        class="nav-link" data-tag-title="الشهر الثامن" id="tag7"
                                                        type="button"> الشهر الثامن</button>
                                                </li>
                                                <li class="nav-item" role="presentation"><button aria-selected="true"
                                                        class="nav-link" data-tag-title="الشهر التاسع" id="tag8"
                                                        type="button">الشهر التاسع </button>
                                                </li>
        ...
        font-size: 25px;
        padding: 0 0 30px 0;">أقسام
                            إنجابي </p>
                        <div class="col-sm-3 card_circle_image">
                            <div class="circle_image">
                                <img class="" src="{{ asset('pages/img/category/pregnancy_10217205.png') }}"
                                    alt="">
                            </div>
                            <p>أشهر الحمل</p>
                        </div>
                        <div class="col-sm-3 card_circle_image">
                            <div class="circle_image">
                                <img class="" src="{{ asset('pages/img/category/video_2306737.png') }}"
                                    alt="">
                            </div>
                            <p>إنجابي TV</p>
                        </div>
                        <div class="col-sm-3 card_circle_image">
                            <div class="circle_image">
                                <img class="" src="{{ asset('pages/img/category/fetus_8041564.png') }}"
                                    alt="">
                            </div>
                            <p>صحة الطفل</p>
                        </div>
                        <div class="col-sm-3 card_circle_image">
                            <div class="circle_image">
                                <img class="" src="{{ asset('pages/img/category/maternity_7901883.png') }}"
                                    alt="">
                            </div>
                            <p>صحتك ماما</p>
                        </div>
                        <div class="col-sm-3 card_circle_image">
                            <div class="circle_image">
                                <img class="" src="{{ asset('pages/img/category/pregnant_6205006.png') }}"
                                    alt="">
                            </div>
                            <p>منوعات إنجابي</p>
                        </div>
                        <div class="col-sm-3 card_circle_image">
                            <div class="circle_image">
                                <img class="" src="{{ asset('pages/img/category/maternity_4577177.png') }}"
                                    alt="">
                            </div>
                            <p>اعتني بنفسك</p>
                        </div>
                        <div class="col-sm-3 card_circle_image">
                            <div class="circle_image">
                                <img class="" src="{{ asset('pages/img/category/love_7409875.png') }}"
                                    alt="">
                            </div>
                            <p>اعتني بطفلك</p>
                        </div>
            ...
            <div class="center_content_Left">
                <div class="widget rounded">
                    <div class="widget-about data-bg-image text-center">
                        ...
                        <p class="mb-4">إنجابي هي منصة صحية تثقيفية نعل من خلالها على توفير المعلومات الطبية الموثوقة
                            لصحة الأم والطفل خلال فترات الحمل والأمومة.</p>
        ...
        <div class="bottom_content">
            <div class="post-tabs rounded bordered" dir="ltr">
                ...
                <ul class="nav nav-tabs nav-pills nav-fill" id="postsTab" role="tablist"
                    ...
                    <li class="nav-item" role="presentation"><button aria-selected="true" class="nav-link active"
                            style="width: 130px" data-tag-title="صحتك ماما" id="baby1" type="button"> صحتك ماما
                        </button>
                    </li>
                    <li class="nav-item" role="presentation"><button aria-selected="true" style="width: 130px"
                            class="nav-link" data-tag-title="صحة الطفل" id="baby" type="button"> صحةالطفل
                        </button>
                    </li>
                </ul>
            </div>
                                ...
                                <div class="col-lg-2">
                                    <div class="ltn__blog-item">
                                        <div class="ltn__blog-img">
                                            <a href="{{ route('ShoWarticle', ['id' => $post->id]) }}"><img
                                                    src="{{ asset($post->IMG) }}" alt="#"></a>
                                        </div>
                                        <div class="ltn__blog-brief" style="padding: 0 !important">
                                            ...
                                            <h3 class="ltn__blog" style="font-size: 16px"><a
                                                    href="{{ route('ShoWarticle', ['id' => $post->id]) }}">{{ $post->TITLE }}</a>
                                            </h3>
                                        </div>
                                    </div>
                                </div>
        ...
        <div
            class="grid grid-cols-12 sm:grid-cols-12 md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12 gap-4 mb-4 container">
            @foreach ($defaultPosts as $defaultPost)
                <div class="col-span-12 sm:col-span-12  md:col-span-6 lg:col-span-6 xl:col-span-6 ">
                    <div class="bg-white dark:bg-gray-800/40 backdrop-blur-2xl  rounded-2xl w-full relative p-4"
                        style="border: 2px solid #eee;height:200px">
                        <div
...
">
                                ...
                                <a href="{{ route('ShoWarticle', ['id' => $defaultPost->id]) }}"
                                    class="text-lg sm:text-xl font-semibold  text-gray-600 dark:text-slate-200 block">
                                    {{ $defaultPost->TITLE }}
                                </a>
                            </div><!--end col-->
                            <div class="col-span-12 sm:col-span-6  md:col-span-6 lg:col-span-4 xl:col-span-4 ">
                                ...
                                <div class=" h-full flex flex-col p-3">
                                    ...
                                    <a href="{{ route('ShoWarticle', ['id' => $defaultPost['id']]) }}"><img
                                            src="{{ asset($defaultPost->IMG) }}" alt=""
                                            class="max-w-full h-auto rounded-xl"></a>
                                    ...
                                    <div class="flex flex-wrap justify-between mt-auto">
                                        ...
                                        <a href="{{ route('ShoWarticle', ['id' => $defaultPost->id]) }}"
                                            class="block text-slate-500 dark:text-slate-400 hover:text-slate-600 underline decoration-1 decoration-dashed underline-offset-4  decoration-primary-500 font-medium  focus:outline-none self-center"
                                            style='    position: absolute;
    left: 42px;
    bottom: 31px;'><i
                                                data-lucide="arrow-left"
                                                class="self-center inline-block ms-1 h-4 w-4"></i>قراءة المزيد </a>
                                    </div>
                                </div><!--end card-body-->
                            </div><!--end col-->
                        </div><!--end grid-->
