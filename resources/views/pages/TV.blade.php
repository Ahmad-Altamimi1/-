...
h3{
    ...
    {{-- <div class="ltn__breadcrumb-area ltn__breadcrumb-area-4 ltn__breadcrumb-color-white---" style="background-image:url(../{{ $video->tag->IMG }})"> --}}
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="ltn__breadcrumb-inner text-center">
                        <h1 class="ltn__page-title">{{ $video->TITLE }}</h1>
                ...
                <div class="col-lg-8">
                    <div class="ltn__blog-details-wrap">
                        <div class="ltn__page-details-inner ltn__blog-details-inner">
                            <div class="ltn__blog-meta" style="text-align: right;">
                                <ul>
                                    ...
                                    <li class="ltn__blog-author d-none">
                                        {{-- <a href="#">by: {{ $video->user->name }}</a> --}}
                                    </li>
                                    <li>
                                                            <span>{{ \Carbon\Carbon::parse($video->DATE_SCHEDULER)->locale('ar')->isoFormat('MMM DD, YYYY') }}</span>
                            ...
                            <h3 class="ltn__blog-title blog-title-line" style="text-align: right"><a >{{ $video->TITLE }} </a></h3>
                            {{-- <img class="blog-details-main-image mb-15" src="../{{ $video->IMG }}" alt="Image" data-toggle="modal" data-target="#imageModal"> --}}
                            <iframe width="700" height="415" src="https://www.youtube.com/embed/{{ $video->VID }}">
                            </iframe>
<p style="word-break: break-all; text-align:right">  <?php echo $video->TEXT1 ?>  </p>
<p>{{ $video->TEXT2 }}</p>
<p>{{ $video->TEXT3 }}</p>
...
{{-- لعرض الصوره في موديل  --}}
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            ">
                <h5 class="modal-title" id="imageModalLabel" >{{ $video->TITLE }} </h5>
            ...
            <div class="modal-body">
                ...
                <img src="{{ asset($video->IMG) }}" class="img-fluid" alt="Image">
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="col-12">
                        <div class="ltn__product-item text-center">
                            <div class="product-img">
                                <a href="{{ route('ShoWarticle',['id'=>$Othervideo->id]) }}"><img src="{{ asset('../'. $Othervideo->IMG) }}" alt="#"></a>
                            ...
                            <div class="product-info">
                                <h2 class="product-title"><a href="{{ route('ShoWarticle',['id'=>$Othervideo->id]) }}">{{ $Othervideo->TITLE }}</a></h2>
                ...
                <div class="col-lg-4">
                    <aside class="sidebar-area blog-sidebar ltn__right-sidebar">
                        ...
                        <div class="widget ltn__author-widget">
                         <h2 class="ltn__widget-title">الفيديوهات المشابهه</h2>
                        ...
                        <!-- Popular Post Widget -->
                           <div class="widget ltn__popular-post-widget">
                            <h2 class="ltn__widget-title">الفيديوهات الحديثه</h2>
